...
//RACES: 
//locking same node by same user
//locking same node ny different user
//locking parent child by same user
//locking parent child by different user
//upgrading and locking same node 
// upgrading and locking parent child
