class Insert_Intervals_75 {
    ...
    // Brute: Add the new interval and oldintervals in a new list sort the list and
    // apply merge interval : Time : nlogn

    // Optimal : O(n) : itertae and check accordinlgy as it is already sorted and
    // non overlapping
    ...
    public int[][] insert(int[][] intervals, int[] newInterval) {
        ...
        for (int[] in : intervals) {
            ...
            if (in[1] < newInterval[0]) {
                ...
                // newinterval is lesser so just swap and add the lesser value : update the
                // ineterval
