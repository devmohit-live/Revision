...
public class MeetingRooms {
    ...
    // Meeting Rooms 2 : minimum number of conference rooms required(no of conflicts
    // / merges)
    ...
    public int minMeetingRooms(List<Interval> intervals) {
        ...
        // so that we can decide if there is ant room those meeting is about to end so
        // that we can start another in that room :
